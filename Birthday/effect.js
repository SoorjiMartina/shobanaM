...
$('document').ready(function(){
		...
		$(window).resize(function(){
			 vw = $(window).width()/2;
			$('#b1,#b2,#b3,#b4,#b5,#b6,#b7,#b8,#b9,#b53').stop();
			...
			$('#b991').animate({top:240, left: vw+400},500);
		});
	...
	function loopFiftyThree() {
		var randleft = 1000*Math.random();
		var randtop = 500*Math.random();
		$('#b53').animate({left:randleft,bottom:randtop},10000,function(){
			loopFiftyThree();
		});
	}
	...
	$('#balloons_flying').click(function(){
		...
		$('#b1,#b4,#b5,#b7,#b9,#b53').addClass('balloons-rotate-behaviour-one');
	...
	$('#wish_message').click(function(){
		...
		$('#b991').animate({top:240, left: vw+400},500);
		$('#b1010').animate({top:240, left: vw+500},500);
